...
public class DefaultRiskService implements RiskService {
    ...
    private String getSummary(Map<String, Integer> riskCount) {
        ...
        if (highCount > 2) {
            return "В Вашем договоре было выявлено большое количество условий с высоким риском, что может повлечь неблагоприятные для Вас последствия. Рекомендуем обратить особое внимание на эти условия.";
        }
        if (highCount != 0) {
            return "В Вашем договоре были выявлены условия с высоким риском, что может повлечь неблагоприятные для Вас последствия. Рекомендуем обратить особое внимание на эти условия.";
        }
        if (middleCount > (lowCount + highCount) / 2) {
            return "В Вашем договоре не выявлено условий с высоким риском, однако ряд условий влечет возможность возникновения среднего уровня риска. Рекомендуем обратить особое внимание на эти условия.";
        }
