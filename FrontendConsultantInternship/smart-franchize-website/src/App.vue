<template>
  <div id="app">
    ...
    <footer><p>
      Информация, содержащаяся на Сайте, включая авторские материалы (комментарии, статьи, ответы на вопросы и т.д.), имеет справочный характер.<br> Компания «СмартФранчайз»‎ не несет ответственности за правильность информации, изложенной в авторских материалах.<br>
